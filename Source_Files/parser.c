...
//    char binary[25];
//    printf("opcode: %d, src_mode: %d, dest_mode: %d, src_reg: %d, dest_reg: %d, funct: %d\n",
//           opcode, src_mode, dest_mode, src_reg, dest_reg, funct);
...
//        if (sym->is_external)
//            sprintf(binary,  "%s001", bin_address); /* E */
//        else
//            sprintf(binary,  "%s010", bin_address); /* R */
//    } else {
//        sprintf(binary,  "%021d010", 0); /* Default R until resolved */
//    }
//
//    binary[24] = '\0';
//    add_code_row(address);
